...
const CommentCard = (props: Props) => {
  return (
    <div className="min-h-[430px] bg-white max-w-[384px] rounded-[20px] comment-card-shadow shrink-0">
      <div className="flex flex-col p-8 space-y-4">
        <div className="flex items-center py-4 space-x-2">
          <img
            ...
            alt=""
          />
          <h6 className="text-main-color-4 text-[20px] font-bold ">
            {props.userInfo.logoName}
          </h6>
        </div>
        <div>
          <p className="text-black font-normal text-[24px] leading-[38.4px]">
